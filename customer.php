...
?>
<form action="svcustomer.php" method="post">

	<p align="center" style="font-size: xx-large; color: #008000; font-style: normal; font-variant: normal; font-weight: bold; font-family: Calibri; position: static; width: 874px;">INPUT DATA CUSTOMER<table style="width: 60%; left: -247px; top: 0px;" align="center" class="auto-style1">
		<tr>
